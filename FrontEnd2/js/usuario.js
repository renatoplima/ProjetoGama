...
return;
    ...
    if (userstr == null) {
        ...
        document.getElementById("foto").innerHTML = "<img id='imgUser' onerror='erroimg();' src=../imagens/" + userjson.foto + " width='140' height='auto'>";
...
function filtrar(){
    ...
    window.location="dashparceiro.html?"+cod;
...
function erroimg(){
    document.getElementById("imgUser").setAttribute("src","../imagens/user.png");
}